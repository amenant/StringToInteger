...
public class Integer {
	...
	/**
	 * 2nd version : Convert number with many digits
	 * Important thing to understand : substraction between a character and 0 will give the right number,
	 * for example : char 8 - char 0 = 8. We substract indexes in the characters matrix.
	 * Then we multiply the result on each loop to get through decade, hundred, etc...
	 */
